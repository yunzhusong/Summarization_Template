...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def _unfreeze_specified_params(self, model):
        if self.args.insert_adapters:
            # Modules to be learned
            trainable_module_types = (Adapter, T5LayerNorm, nn.LayerNorm)

            # Unfreeze adapter and layer norm
